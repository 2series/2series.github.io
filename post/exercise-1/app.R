...
ui <- fluidPage(
  ...
  # A first-level header (`h1()`) with the content "My first shiny website, Hello Shiny!"
  h1("My first shiny website, Hello Shiny!"),
  
  # A paragraph (`p()`) with content saying how excited you are about Shiny.
  # The paragraph should include some `strong()` content.
  p("Hey! this is my", strong("first"), "shiny project, and I'm loving it..."),
  ...
  sliderInput("my_slider", "My First Slider", min = 10, max = 100, value = 50)
